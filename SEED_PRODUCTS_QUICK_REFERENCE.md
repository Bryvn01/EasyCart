...
export MONGO_URI="mongodb+srv://<username>:<password>@cluster.mongodb.net/easycart"
...
|----------|----------|---------|---------|
| `MONGO_URI` | ✅ Yes | MongoDB connection string | `mongodb+srv://<username>:<password>@cluster.mongodb.net/easycart` |
