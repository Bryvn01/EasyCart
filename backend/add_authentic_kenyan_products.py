...
def add_authentic_kenyan_products():
    ...
    for prod in products_data:
        ...
        if prod.get('image_url'):
            try:
                response = requests.get(prod['image_url'], timeout=30, headers={
    ...
    print("🏪 Products from trusted Kenyan brands: Brookside, KCC, Pembe, Kabras, Unga, Royco, Coca-Cola, Keringet, Omo, Dettol, Colgate, Nivea, Always, Blue Band, Ajab")
