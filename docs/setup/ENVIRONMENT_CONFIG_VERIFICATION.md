...
| `MONGO_URI` | ✅ | `mongodb+srv://<username>:<password>@cluster.mongodb.net/easycart` | [ ] Set | **Critical** - MongoDB Atlas connection |
...
mongosh "mongodb+srv://<username>:<password>@cluster.mongodb.net/easycart"
