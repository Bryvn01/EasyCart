...
const Button = ({
  ...
  const variants = {
    primary: 'bg-gray-900 hover:bg-gray-800 text-white focus:ring-gray-700 dark:bg-gray-100 dark:hover:bg-gray-200 dark:text-gray-900',
    ...
    outline: 'border border-gray-300 hover:bg-gray-50 text-gray-700 focus:ring-gray-500 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800',
