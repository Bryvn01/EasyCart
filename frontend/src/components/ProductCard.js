...
const ProductCard = ({ product, onAddToCart, onQuickView, loading = false, priority = false }) => {
  ...
  return (
    <Card hover className="product-card group overflow-hidden relative">
      ...
      <div className="product-card-image-container">
        ...
        {product.stock === 0 && (
          <div className="absolute top-2 left-2 z-20" aria-label="Out of Stock">
            <span className="bg-red-700 text-white px-2 py-1 rounded font-semibold text-xs" role="status">
        ...
        {product.discount_percentage > 0 && (
          <div className="absolute top-2 right-2 z-20" aria-label="Discount">
            <span className="bg-gray-900 text-white px-2 py-1 rounded font-semibold text-xs" role="status">
        ...
        {product.stock > 0 && (
          <button
            ...
            className="absolute bottom-2 right-2 bg-white text-gray-800 rounded p-2 border border-gray-200 shadow-sm hover:bg-gray-50 transition-colors"
      ...
      <div className="product-card-content p-4 space-y-2">
        ...
        {/* Rating Section */}
        {product.rating && product.review_count >= 1 && (
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Button
            ...
            loading={loading}
            size="sm"
            className="shrink-0 bg-gray-900 hover:bg-gray-800 border-gray-900"
